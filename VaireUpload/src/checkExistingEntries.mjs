// Reads every already-logged Trask entry for the currently-visible week in
...
// `note` is the entry's free-text description as Trask's calendar view
...
// failure.
import { attachToTraskTab, findExistingLoggedEntries } from './attach.mjs';
